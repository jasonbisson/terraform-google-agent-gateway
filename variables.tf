...
variable "random_project_id" {
  description = "Show random project ID suffix"
  type        = bool
  default     = true
}

variable "deletion_policy" {
  description = "The deletion policy for the project. Options: DELETE, PREVENT, ABANDON."
  type        = string
  default     = "DELETE"
}
